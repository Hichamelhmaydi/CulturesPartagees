...
class Inscription {
    ...
    public function setValues($nom, $prenom, $email, $user_password, $role, $profile) {
    ...
    public function register() {
        ...
        if ($emailExists > 0) {
            ...
            $stmt->bindParam(6, $this->profile, PDO::PARAM_LOB); 
    
            if ($stmt->execute()) {
                header('Location: ../views/login.php');
                exit;
            } else {
                echo "il y a une erreur lors de l'insertion.";
            }
        }
    }
}
